...
<body class="theme-teal">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li class="active">
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="indexproduksi.php">Program</a>
                            </li>
                            <li>
                                <a href="indexproduksi.php?produksi=jadwal">Jadwal Produksi</a>
                            </li>
                            <li>
                                <a href="indexproduksi.php?produksi=kegliputan">Kegiatan Liputan</a>
                            </li>
                            <li>
                                <a href="indexproduksi.php?produksi=laporan">Laporan</a>
                            </li>
                        </ul>
                    </li>
                    <?php } ?>
    ...
    <section class="content">
        <div class="container-fluid">
            <!-- Body content main -->
            <?php
                $produksi = @$_GET['produksicase'];
                switch ($produksi) {
                    default:
                        include 'produksicase/main.php';
                        break;
                }
                ?>
