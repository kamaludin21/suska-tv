                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown pull-right">
                        <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button">
                            <div class="msg pull-left" style="margin: 3.4px 3px 0 0;"><?= $_SESSION["nama"];?></div>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info" style="background: url(../images/bg-img5.jpg);">
                ...
                <div class="info-container" style="margin-top: -14px;">
                    <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?= $_SESSION["nama"]; ?>
                    </div>
